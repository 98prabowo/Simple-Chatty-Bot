...
public class SimpleBot {
    ...
    public static void main(String[] args) {
        ...
        String[] choice = {"To repeat a statement multiple times.",
        ...
        greet(assistantName, birthYear); // change it as you need
        remindName();
        guessAge();
        count();
        test(question, choice, answer);
        end();
    }
    ...
    static void test(String question, String[] choice, int answer) {
        System.out.println("Let's test your programming knowledge.");
        System.out.println(question);
        for (int i = 1; i <= choice.length; i++)
            System.out.println(i + "." + choice[i - 1]);
